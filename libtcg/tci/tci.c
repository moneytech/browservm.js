...
# define qemu_ld_ub \
    helper_ldb_mmu(env, taddr, oi, (void*)tb_ptr)
# define qemu_ld_leuw \
    helper_ldw_mmu(env, taddr, oi, (void*)tb_ptr)
# define qemu_ld_leul \
    helper_ldl_mmu(env, taddr, oi, (void*)tb_ptr)
# define qemu_ld_leq \
    helper_ldq_mmu(env, taddr, oi, (void*)tb_ptr)
// # define qemu_ld_beuw \
...
# define qemu_st_b(X) \
    helper_stb_mmu(env, taddr, X, oi, (void*)tb_ptr)
# define qemu_st_lew(X) \
    helper_stw_mmu(env, taddr, X, oi, (void*)tb_ptr)
# define qemu_st_lel(X) \
    helper_stl_mmu(env, taddr, X, oi, (void*)tb_ptr)
# define qemu_st_leq(X) \
    helper_stq_mmu(env, taddr, X, oi, (void*)tb_ptr)
